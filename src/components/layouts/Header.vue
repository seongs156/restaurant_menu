...
<!--          </li>-->
<!--&lt;!&ndash;          <li class="category">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'todo'}">할일</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--&lt;!&ndash;          <li class="category">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'shop'}">SHOP</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--        </ul>-->
<!--        <ul>-->

<!--&lt;!&ndash;          <li class="category" v-if="!loggedIn">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'login'}">로그인</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--&lt;!&ndash;          <li class="category" v-if="!loggedIn">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'register'}">회원가입</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--&lt;!&ndash;          <li v-if="loggedIn">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'admin'}">관리자</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--&lt;!&ndash;          <li class="category" id="my-shopping" v-if="loggedIn" @click="myShoppingBar">&ndash;&gt;-->
<!--&lt;!&ndash;            <a href="#">나의쇼핑</a>&ndash;&gt;-->
<!--&lt;!&ndash;            <ul id="pc-nav-sub">&ndash;&gt;-->
<!--&lt;!&ndash;              <li><router-link :to="{ name: 'cart'}">카트</router-link></li>&ndash;&gt;-->
<!--&lt;!&ndash;              <li><a href="#">내정보</a></li>&ndash;&gt;-->
<!--&lt;!&ndash;            </ul>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--&lt;!&ndash;          <li class="category" v-if="loggedIn">&ndash;&gt;-->
<!--&lt;!&ndash;            <router-link :to="{ name: 'logout'}">로그아웃</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;          </li>&ndash;&gt;-->
<!--        </ul>-->
<!--      </div>-->
<!--    </header>-->
