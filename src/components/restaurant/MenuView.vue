    ...
    <div class="container">
      <div class="row">
        <form @submit.prevent="menuSubmit()">
          <div class="shop-name" style="text-align:center">{{ shop }}</div>
          <div class="text-center update" v-if="dateUpdate">오늘 업로드됨</div>
          <div class="text-center now not-update" v-else>오늘 업로드 안됨</div>
          <b-row class="mt-2">
